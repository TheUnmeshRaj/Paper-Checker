...
def showAnswers(img, myIndex, grading, ans, questions=5, choices=5):
    ...
    for x in range(0, questions):
        ...
        if grading[x] == 1:
            ...
            if isinstance(correctAns, str):  # Handle non-numeric answers
                if correctAns == 'A':
                    correctAns = 0
                elif correctAns == 'B':
                    correctAns = 1
                    ...
                    correctAns = -1  # For unexpected cases like 'Bonus'
            
            cv2.circle(img, ((correctAns * secW) + secW // 2, (x * secH) + secH // 2), radius=20, color=(0, 255, 0), thickness=5)
